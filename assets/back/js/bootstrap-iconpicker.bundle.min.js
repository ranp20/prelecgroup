        ...
        return this.each(function (){
            var $this = $(this),
                ...
                if(data || $this.data("bs.iconpicker", data = new Iconpicker(this, options)), "string" == typeof option){
                    ...
                    "BUTTON" === $this.prop("tagName") ? ($this.empty().append("<i></i>").append('<input type="hidden" ' + name + "></input>").append('<span class="mr-1"></span>').addClass("iconpicker " + ("3.x" === $.fn.bsVersion() ? "" : "dropdown-toggle")), 
