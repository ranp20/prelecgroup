...
(function (h) {
    ...
    function Sa(a, b, c) {
        var d = a._iDisplayStart,
            ...
            f = a.fnRecordsDisplay();
        0 === f || -1 ===
            e ? d = 0 : "number" === typeof b ? (d = b * e, d > f && (d = 0)) : "first" == b ? d = 0 : "Previo" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) : "next" == b ? d + e < f && (d += e) : "last" == b ? d = Math.floor((f - 1) / e) * e : J(a, 0, "Unknown paging action: " + b, 5);
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sInfo: "Visualizar _START_ to _END_ of _TOTAL_ entries",
            sInfoEmpty: "Visualizar 0 to 0 of 0 entries",
            sInfoFiltered: "(filtered from _MAX_ total entries)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
            sLengthMenu: "Visualizar _MENU_ entries",
    ...
    h.extend(Kb, {
        ...
        full: function () {
            return ["first", "Previo", "Siguiente", "last"]
        },
        ...
        simple_numbers: function (a, b) {
            return ["Previo", ha(a, b), "Siguiente"]
        },
        full_numbers: function (a, b) {
            return ["primero", "Previo", ha(a, b), "Siguiente", "last"]
        },
        first_last_numbers: function (a, b) {
            return ["primero", ha(a, b), "last"]
        },
        _numbers: ha,
        numbers_length: 7
    });
