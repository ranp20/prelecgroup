						...
						<div class="col-lg-12">
								<form class="admin-form" action="{{ route('back.shipping.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="ciudad_id" id="ciudad_id" data-href="{{route('back.get.distrito')}}" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" id="price" name="price" class="form-control" placeholder="{{ __('Enter Price') }}" value="{{ old('price') }}" >
                                        </div>
                                    </div>
									<div class="form-group">
