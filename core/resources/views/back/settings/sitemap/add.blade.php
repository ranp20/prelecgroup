						...
						<div class="col-lg-12">
							<div class="p-3">
								<div class="row">
									...
									<div class="col-md-6">
										<form class="admin-form" action="{{ route('back.sitemap.store') }}" method="POST" enctype="multipart/form-data">
											@csrf
											...
											<div class="row d-none">
												<div class="col-md-6">
													<div class="form-group">
														...
														<input type="hidden" name="sitemap_lat" class="form-control" id="sitemap_lat" placeholder="{{ __('Latitude') }}" value="{{ old('sitemap_lat') }}">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label for="sitemap_lng">{{ __('Length') }} *</label>
														<input type="hidden" name="sitemap_lng" class="form-control" id="sitemap_lng" placeholder="{{ __('Length') }}" value="{{ old('sitemap_lng') }}">
													</div>
												</div>
											</div>
											<div class="form-group">
												<label for="sitemap_name">{{ __('Sitemap name') }} *</label>
												<input type="text" name="sitemap_name" class="form-control" id="sitemap_name" placeholder="{{ __('Sitemap name') }}" value="{{ old('sitemap_name') }}" required>
											</div>
											{{--
											<!--
											...
											<div class="form-group">
												...
												<input type="text" name="sitemap_url" class="form-control" id="sitemap_url" placeholder="{{ __('Sitemap Url') }}" value="{{ old('sitemap_url') }}" required>
											</div>
											-->
											--}}
