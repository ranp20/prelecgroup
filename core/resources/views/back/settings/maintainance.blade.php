                        ...
                        <div class="image-show {{ $setting->is_maintainance == 1 ? '' : 'd-none' }}">
                          <div class="form-group">
                            ...
                            <div class="col-lg-12 pb-1">
                              <img class="admin-img lg" src="{{ $setting->maintainance_image ? asset('assets/images/'.$setting->maintainance_image) : asset('assets/images/placeholder.png') }}" alt="No Image Found">
                            </div>
