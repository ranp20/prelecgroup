...
<tr>
  <td>{{ $data->name }}</td>
  <td>
    <a class="link_viewTargetBlankImg" href="{{ $data->photo ? asset('assets/images/brands/'.$data->photo) : asset('assets/images/placeholder.png') }}" target="_blank">
      <img src="{{ $data->photo ? asset('assets/images/brands/'.$data->photo) : asset('assets/images/placeholder.png') }}" alt="Image Not Found">
    </a>
  </td>
  <td>{{ $data->slug }}</td>
  <td>
  ...
  <td>
    <div class="action-list">
      <a class="btn btn-secondary btn-sm " href="{{ route('back.brand.edit',$data->id) }}">
        <i class="fas fa-edit"></i>
      </a>
      <a class="btn btn-danger btn-sm " data-toggle="modal" data-target="#confirm-delete" href="javascript:;" data-href="{{ route('back.brand.destroy',$data->id) }}">
