            ...
            <table class="table table-bordered mb-0">
              ...
              <tr>
                <td>
                  ...
                  @if ($product->is_stock())
                  <a class="product-button btn btn-primary btn-sm add_to_single_cart" href="javascript:;" data-target="{{$product->id}}">
                    <i class="icon-shopping-cart position-relative z-3"></i>
                    <span class="ms-2">{{__('To Cart')}}</span>
                  </a>
                  @else
                ...
                <td class="text-center">
                  <a class="remove-from-cart" href="{{route('user.wishlist.delete',$product->getWishlistItemId())}}" data-toggle="tooltip" title="Remove item"><i class="icon-x"></i>
                  </a>
                </td>
              </tr>
              @endforeach
