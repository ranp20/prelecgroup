...
<div class="page-title c-tabsSiteMapsIntoSite">
  <div class="container">
    <div class="row">
      <div class="col-lg-12"> 
        <div class="container">
              ...
              <div class="container">
                ...
                <div class="tab">
                  <button class="tablinks" onclick="openTab(event, 'coding', 'arrow1')" id="defaultOpen">
                    <img src="https://grupopdg.com/web/assets/images/1669243349tienda.png">
                    <span class="sitemap__address">JR AGUARICO # 175 DP 202 BREÑA LIMA - LIMA - LIMA.</span>
                    <span id="arrow1" class="arrow fas fa-caret-right"></span>
                  </button>
                  <button class="tablinks" onclick="openTab(event, 'wordPress', 'arrow2')">
                    <img src="https://grupopdg.com/web/assets/images/1669243349tienda.png">
                    <span class="sitemap__address">AV. REPUBLICA DE ARGENTINA NRO. 575 INT. B 19 CENTRO COMERCIAL LA CHIMENEA LIMA - LIMA - LIMA.</span>
                    <span id="arrow1" class="arrow fas fa-caret-right"></span>
                  </button>
                </div>
