			...
			<div class="card o-hidden border-0 shadow-lg">
				<div class="card-body ">
					<div class="row">
						<div class="col-lg-12">
							<div class="p-5">
								<form class="admin-form" action="<?php echo e(route('back.email.update')); ?>" method="POST" enctype="multipart/form-data">
                  <?php echo csrf_field(); ?>
                                        ...
                                        <tr>
                                          ...
                                          <td>
                                            <div class="action-list">
                                              <a class="btn btn-secondary btn-sm" href="<?php echo e(route('back.template.edit',$data->id)); ?>">
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/grupocorein/public_html/core/resources/views/back/settings/email.blade.php ENDPATH**/ ?>